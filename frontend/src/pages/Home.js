    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
          ...
          <a
            href="/products"
            className="bg-yellow-500 text-gray-900 px-6 py-3 rounded-full font-semibold hover:bg-yellow-600 transition"
          >
            Explore Now
          </a>
        </div>
        ...
        {!loading && products.length > 0 ? (
          <>
            ...
            <div className="text-center">
              <a
                href="/products"
                className="inline-block bg-gray-200 hover:bg-gray-300 text-gray-900 px-8 py-3 rounded-full font-semibold transition"
              >
                View Collection
              </a>
            </div>
          ...
          {!loading && products.length > 0 && (
            <>
              ...
              <div className="text-center">
                <a
                  href="/products"
                  className="inline-block bg-yellow-500 hover:bg-yellow-600 text-gray-900 px-8 py-3 rounded-full font-semibold transition"
                >
                  View Collection
                </a>
              </div>
      ...
      <section className="bg-yellow-500 py-12">
        <div className="max-w-3xl mx-auto text-center px-4">
          ...
          <a
            href="/stores"
            className="bg-gray-900 text-yellow-500 px-6 py-3 rounded-full font-semibold hover:bg-gray-800 transition"
          >
            Visit Our Stores
          </a>
        </div>
